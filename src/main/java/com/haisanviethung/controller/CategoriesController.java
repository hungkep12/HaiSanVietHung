...
//	@GetMapping("/{nameCategory}/cart")
//
//	public String addToCart(@PathVariable String nameCategory, ModelMap model, HttpServletRequest request,
...
//		}
//
//		return danhMuc(nameCategory, request, response, model);
//
//	}
