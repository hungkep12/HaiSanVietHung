		...
		<main>
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-4">
					...
					<li class="breadcrumb-item active" aria-current="page">Sửa bài
						viết</li>
				</ol>
				<div class="row">
						...
						<div class="card mb-4" style="clear: both;">
							...
							<div class="card-body">
								<form:form modelAttribute="post" id="validationform"
									...
									action="/admin/posts/edit_post" enctype="multipart/form-data">
									<form:hidden path="id" />
									...
									<div class="form-group row">
										...
										<div class="col-12 col-sm-8 col-lg-6">
											<form:select class="form-control" path="type"
												style="width: 200px;">
												<form:option value="tin tức">Tin tức</form:option>
												<form:option value="chính sách">Chính sách</form:option>
											</form:select>
										</div>
									</div>
									<div class="form-group row">
