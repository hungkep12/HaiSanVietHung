			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-4">
					...
					<li class="breadcrumb-item"><a
						...
						class="breadcrumb-link">Sửa sản phẩm</a></li>
					<li class="breadcrumb-item active" aria-current="page">Sửa ảnh
						sản phẩm</li>
				</ol>
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card mb-4" style="clear: both;">
							<h5 class="card-header">Sửa ảnh sản phẩm</h5>
							<div class="card-body">
								<form:form modelAttribute="image" id="validationform"
									data-parsley-validate="" novalidate="" method="POST"
									action="/admin/products/${product.id}/edit_image"
									...
									<div class="form-group row">
										...
										<div class="col-12 col-sm-8 col-lg-6">
											<input type="file" value="" placeholder=""
												class="form-control" name="productImg">
										</div>
									</div>
									<div class="form-group row text-right">
										<div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
											<input type="submit" class="btn btn-space btn-primary"
												value="Lưu" /> <a
												href="${pageContext.request.contextPath}/admin/products/${product.id}"><input
												type="button" value="Hủy"
												class="btn btn-space btn-secondary"></a>
										</div>
									</div>
								</form:form>
							</div>
