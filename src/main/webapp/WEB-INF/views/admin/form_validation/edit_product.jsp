		...
		<main>
			<div class="container-fluid">
				...
				<ol class="breadcrumb mb-4">
					...
					<li class="breadcrumb-item active" aria-current="page">Sửa sản
						phẩm</li>
				</ol>
						...
						<div class="card mb-4" style="clear: both;">
							...
							<div class="card-body">
								<form:form modelAttribute="product" id="validationform"
									...
									action="/admin/products/edit_product"
									...
									<div class="form-group row">
										...
										<div class="col-12 col-sm-8 col-lg-6">
											<form:input path="nameProduct" type="text" required=""
									...
									<div class="form-group row">
										...
										<div class="col-12 col-sm-8 col-lg-6">
											<form:input path="price" type="number" required=""
												placeholder="" class="form-control" step="1000" min="0" />
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										<label class="col-12 col-sm-3 col-form-label text-sm-right">Số
											lượng </label>
										<div class="col-12 col-sm-8 col-lg-6">
											<form:input path="quantity" type="number" required=""
												placeholder="" class="form-control" />
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-12 col-sm-8 col-lg-6">
											<form:textarea path="description" id="description"
												required="" class="form-control"></form:textarea>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-12 col-sm-3 col-form-label text-sm-right">Chi
											tiết</label>
										<div class="col-12 col-sm-8 col-lg-6">
											<form:textarea path="detail" id="detail" required=""
								...
								<div class="form-group row">
									<label class="col-12 col-sm-3 col-form-label text-sm-right">Ảnh</label><a
										href="${pageContext.request.contextPath}/admin/products/${product.id }/image/add"
										style="color: white;">
								...
								<div class="form-group row">
									...
									<div class="col-12 col-sm-8 col-lg-6">
										...
										<c:forEach var="images" items="${images }">
											...
											<a
												href="${pageContext.request.contextPath}/admin/products/${product.id }/image/${images.id }"
												style="color: white;"><button
													class="btn btn-success btn-sm rounded-0" type="button"
													data-toggle="tooltip" data-placement="top" title="">
													<i class="fa fa-edit"></i>Sửa
												</button> </a>
											<a href="/admin/products/${product.id }/delete/${images.id }"
												onclick="return confirm('Bạn có muốn xóa ảnh này?');">
