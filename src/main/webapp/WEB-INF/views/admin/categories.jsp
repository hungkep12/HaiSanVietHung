	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container-fluid">
				...
				<div style="width: 100%;">
					<a href="/admin/categories/add" style="color: white;">
				...
				<div class="card mb-4" style="clear: both;">
					<div class="card-header">
						<i class="fas fa-table mr-1"></i> Bảng dữ liệu danh mục sản phẩm
					</div>
					<div class="card-body">
									...
									<c:forEach var="categories" items="${categories }">
										<tr>
											...
											<td><img width="50" height="50"
												src="${pageContext.request.contextPath}/${categories.image }"
												class="lazy-load show-on-hover absolute fill hide-for-small back-image"
												alt="" /></td>
											<td><a
												href="${pageContext.request.contextPath}/admin/categories/${categories.id }"
												style="color: white;"><button
														class="btn btn-success btn-sm rounded-0" type="button"
														data-toggle="tooltip" data-placement="top" title="">
														<i class="fa fa-edit"></i>Sửa
													</button> </a> <a href="/admin/categories/delete/${categories.id }"
